...
public class ScrapAndSaveToDB {
    public static List<OffreClass> listOffres = new ArrayList<OffreClass>(); // Table Offre
    ...
    public static LangueClass getLangueAndLevel(String langueScraped){
        ...
        return new LangueClass(langueName, level);
    }
        ...
        for(String numberURL : urls){
            ...
            try {
                ...
                for(Element offre : offres){
                    ...
                    // Here is for sleeping for a rundom period of seconds between 4 and 8sec
                    ...
                    List<SkillClass> listSkills = new ArrayList<SkillClass>();
                    List<LangueClass> listLangues = new ArrayList<LangueClass>(); 
                            ...
                            for(Element fieldItem : lastCell){
                                ...
                                switch (firstCell) {
                                    ...
                                    case "Compétences clés :":
                                        listSkills.add(new SkillClass(item, "hard"));
                                        break;
                                    default:
                                        break;
                                }
