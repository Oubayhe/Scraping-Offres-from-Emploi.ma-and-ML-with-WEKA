...
public class anotherML {
    public static void main(String[] args) throws Exception {
        ...
        String predictedClass = returnPredictedClass(classifier);
    ...
    public static String returnPredictedClass(J48 classifier) throws Exception{
        ...
        Instance testInstance = newData.instance(5); // Random - User Choice
