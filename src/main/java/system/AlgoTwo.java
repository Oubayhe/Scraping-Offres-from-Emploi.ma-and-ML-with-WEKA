...
public class AlgoTwo {
    public static void main(String[] args) throws Exception {
        ...
        RandomForest classifier = returnTheClassifier(data);
    ...
    public static String returnPredictedClass(RandomForest classifier, Instances data) throws Exception {
    ...
    public static RandomForest returnTheClassifier(Instances data) throws Exception {
    ...
    public static Evaluation returnEval(Instances data, RandomForest classifier) throws Exception {
